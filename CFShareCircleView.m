...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
             _sharers = [[NSMutableArray alloc] initWithObjects:[CFSharer line], [CFSharer facebook], [CFSharer whatsapp],[CFSharer more],[CFSharer sina_weibo],[CFSharer twitter],nil];
